...
const TRANSLATIONS = {
    en: {
        ...
        chain_warning: " Wrong Network: Detected network different from Polygon POS (137).",
        ...
        btn_sign_execute: " SIGN & EXECUTE ON POLYGON (USDT)",
        ...
        "btn_unlock_live": "UNLOCK REAL TRADING (CONNECT WALLET)",
        "btn_paper_trade": "TEST PAPER EXECUTION",
        "btn_real_trade": "EXECUTE ON-CHAIN TRADE",
        "preventivo_title": "ON-CHAIN TRADE EXECUTION PREVENTIVO",
        "preventivo_desc": "Every on-chain trade executes with non-custodial Position Guardian protection and direct Blockchain+ DAO quota settlement.",
        "preventivo_pair": "TRADING PAIR:",
        "preventivo_action": "ALGORITHMIC ACTION:",
        "preventivo_alloc": "ALLOCATION AMOUNT:",
        "preventivo_dao_quota": "BLOCKCHAIN+ DAO QUOTA (POL):",
        "preventivo_gas": "ESTIMATED NETWORK GAS:",
        "preventivo_total": "TOTAL POL REQUIRED TO SIGN:",
        "preventivo_recipient": "TREASURY RECIPIENT:",
        "btn_sign_trade": "SIGN ON-CHAIN (10 POL + GAS)",
        "btn_cancel": "CANCEL",
        "pos_simulated": "SIMULATED",
        "pos_live": "LIVE ON-CHAIN",
        "btn_close_pos": "CLOSE POSITION TO USDT",
    ...
    it: {
        ...
        chain_warning: " Rete Errata: Rilevata rete diversa da Polygon POS (137).",
        ...
        btn_sign_execute: " FIRMA ED ESEGUI SU POLYGON (USDT)",
        ...
        "btn_unlock_live": "ATTIVA TRADING REALE (CONNETTI WALLET)",
        "btn_paper_trade": "TEST ESECUZIONE PAPER",
        "btn_real_trade": "ESEGUI TRADE ON-CHAIN",
        "preventivo_title": "PREVENTIVO ESECUZIONE TRADE ON-CHAIN",
        "preventivo_desc": "Ogni trade on-chain viene firmato con protezione non-custodial Position Guardian e quota DAO Blockchain+.",
        "preventivo_pair": "COPPIA DI TRADING:",
        "preventivo_action": "AZIONE ALGORITMICA:",
        "preventivo_alloc": "IMPORTO ALLOCATO:",
        "preventivo_dao_quota": "QUOTA DAO BLOCKCHAIN+ (POL):",
        "preventivo_gas": "GAS STIMATO RETE:",
        "preventivo_total": "TOTALE POL RICHIESTO PER FIRMA:",
        "preventivo_recipient": "TESORERIA DESTINATARIA:",
        "btn_sign_trade": "FIRMA ON-CHAIN (10 POL + GAS)",
        "btn_cancel": "ANNULLA",
        "pos_simulated": "SIMULATA",
        "pos_live": "LIVE ON-CHAIN",
        "btn_close_pos": "CHIUDI POSIZIONE IN USDT",
    ...
    zh: {
        ...
        connect_wallet: " 连接钱包",
        disconnect: "断开连接",
        chain_warning: " 网络错误：检测到非 Polygon POS (137) 网络。",
        ...
        btn_sign_execute: " 在 POLYGON 上签名并执行 (USDT)",
        ...
        "btn_unlock_live": "激活实盘交易（连接钱包）",
        "btn_paper_trade": "测试模拟执行",
        "btn_real_trade": "执行链上交易",
        "preventivo_title": "链上交易执行报价单",
        "preventivo_desc": "每笔链上交易均具有非托管 Position Guardian 保护，并直接结算 Blockchain+ DAO 配额。",
        "preventivo_pair": "交易对：",
        "preventivo_action": "算法动作：",
        "preventivo_alloc": "分配金额：",
        "preventivo_dao_quota": "BLOCKCHAIN+ DAO 配额 (POL)：",
        "preventivo_gas": "预估网络 GAS：",
        "preventivo_total": "签名所需 POL 总计：",
        "preventivo_recipient": "DAO 金库接收地址：",
        "btn_sign_trade": "链上签名 (10 POL + GAS)",
        "btn_cancel": "取消",
        "pos_simulated": "模拟",
        "pos_live": "链上实盘",
        "btn_close_pos": "平仓兑换为 USDT",
    ...
    es: {
        ...
        chain_warning: " Red Incorrecta: Se detectó una red diferente a Polygon POS (137).",
        ...
        btn_sign_execute: " FIRMAR Y EJECUTAR EN POLYGON (USDT)",
        ...
        "btn_unlock_live": "ACTIVAR TRADING REAL (CONECTAR WALLET)",
        "btn_paper_trade": "PROBAR EJECUCIÓN PAPER",
        "btn_real_trade": "EJECUTAR OPERACIÓN ON-CHAIN",
        "preventivo_title": "PRESUPUESTO DE EJECUCIÓN ON-CHAIN",
        "preventivo_desc": "Cada operación on-chain se ejecuta con protección Position Guardian y cuota DAO Blockchain+.",
        "preventivo_pair": "PAR DE TRADING:",
        "preventivo_action": "ACCIÓN ALGORÍTMICA:",
        "preventivo_alloc": "CANTIDAD ASIGNADA:",
        "preventivo_dao_quota": "CUOTA DAO BLOCKCHAIN+ (POL):",
        "preventivo_gas": "GAS DE RED ESTIMADO:",
        "preventivo_total": "TOTAL POL A FIRMAR:",
        "preventivo_recipient": "TESORERÍA DESTINO:",
        "btn_sign_trade": "FIRMAR ON-CHAIN (10 POL + GAS)",
        "btn_cancel": "CANCELAR",
        "pos_simulated": "SIMULADA",
        "pos_live": "LIVE ON-CHAIN",
        "btn_close_pos": "CERRAR POSICIÓN A USDT",
    ...
    de: {
        ...
        disconnect: "Trennen",
        chain_warning: " Falsches Netzwerk: Anderes Netzwerk als Polygon POS (137) erkannt.",
        ...
        btn_sign_execute: " AUF POLYGON SIGNIEREN & AUSFÜHREN (USDT)",
        ...
        "btn_unlock_live": "ECHTGELD-TRADING FREISCHALTEN (WALLET VERBINDEN)",
        "btn_paper_trade": "PAPIER-AUSFÜHRUNG TESTEN",
        "btn_real_trade": "ON-CHAIN TRADE AUSFÜHREN",
        "preventivo_title": "ON-CHAIN AUSFÜHRUNGS-KOSTENVORANSCHLAG",
        "preventivo_desc": "Jeder On-Chain-Trade wird mit Position Guardian-Schutz und Blockchain+ DAO-Quote ausgeführt.",
        "preventivo_pair": "HANDELSPAAR:",
        "preventivo_action": "ALGORITHMISCHE AKTION:",
        "preventivo_alloc": "ALLOKATIONSBETRAG:",
        "preventivo_dao_quota": "BLOCKCHAIN+ DAO-QUOTE (POL):",
        "preventivo_gas": "GESCHÄTZTES NETZWERK-GAS:",
        "preventivo_total": "GESAMT-POL ZUR SIGNATUR:",
        "preventivo_recipient": "EMPFÄNGER (TREASURY):",
        "btn_sign_trade": "ON-CHAIN SIGNIEREN (10 POL + GAS)",
        "btn_cancel": "ABBRECHEN",
        "pos_simulated": "SIMULIERT",
        "pos_live": "LIVE ON-CHAIN",
        "btn_close_pos": "POSITION IN USDT SCHLIESSEN",
    ...
    fr: {
        ...
        chain_warning: " Mauvais Réseau : Réseau différent de Polygon POS (137) détecté.",
        ...
        btn_sign_execute: " SIGNER ET EXÉCUTER SUR POLYGON (USDT)",
        ...
        "btn_unlock_live": "DÉVERROUILLER LE TRADING RÉEL (CONNECTER LE WALLET)",
        "btn_paper_trade": "TESTER L'EXÉCUTION PAPER",
        "btn_real_trade": "EXÉCUTER LE TRADE ON-CHAIN",
        "preventivo_title": "DEVIS D'EXÉCUTION DU TRADE ON-CHAIN",
        "preventivo_desc": "Chaque transaction on-chain est exécutée avec la protection Position Guardian et la quote-part DAO Blockchain+.",
        "preventivo_pair": "PAIRE DE TRADING:",
        "preventivo_action": "ACTION ALGORITHMIQUE:",
        "preventivo_alloc": "MONTANT ALLOUÉ:",
        "preventivo_dao_quota": "QUOTE-PART DAO BLOCKCHAIN+ (POL):",
        "preventivo_gas": "GAS RÉSEAU ESTIMÉ:",
        "preventivo_total": "TOTAL POL À SIGNER:",
        "preventivo_recipient": "TRÉSORERIE DESTINATAIRE:",
        "btn_sign_trade": "SIGNER ON-CHAIN (10 POL + GAS)",
        "btn_cancel": "ANNULER",
        "pos_simulated": "SIMULÉ",
        "pos_live": "LIVE ON-CHAIN",
        "btn_close_pos": "CLÔTURER EN USDT",
    ...
    ja: {
        ...
        disconnect: "切断",
        chain_warning: " ネットワークエラー: Polygon POS (137) 以外のネットワークが検出されました。",
        ...
        btn_sign_execute: " POLYGONで署名・実行 (USDT)",
        ...
        "btn_unlock_live": "本番取引を有効化（ウォレット接続）",
        "btn_paper_trade": "ペーパー取引をテスト",
        "btn_real_trade": "オンチェーントレードを実行",
        "preventivo_title": "オンチェーントレード実行見積",
        "preventivo_desc": "すべてのオンチェーントレードは Position Guardian 保護と Blockchain+ DAO クォータ決済で実行されます。",
        "preventivo_pair": "取引ペア：",
        "preventivo_action": "アルゴリズムアクション：",
        "preventivo_alloc": "配分金額：",
        "preventivo_dao_quota": "BLOCKCHAIN+ DAO クォータ (POL)：",
        "preventivo_gas": "推定ネットワークGAS：",
        "preventivo_total": "署名に必要な合計 POL：",
        "preventivo_recipient": "DAO 金庫受取先：",
        "btn_sign_trade": "オンチェーン署名 (10 POL + GAS)",
        "btn_cancel": "キャンセル",
        "pos_simulated": "シミュレーション",
        "pos_live": "オンチェーン本番",
        "btn_close_pos": "USDTに決済してポジション終了",
    ...
    pt: {
        ...
        disconnect: "Desconectar",
        chain_warning: " Rede Incorreta: Rede diferente da Polygon POS (137) detectada.",
        ...
        btn_sign_execute: " ASSINAR E EXECUTAR NA POLYGON (USDT)",
        ...
        "btn_unlock_live": "DESBLOQUEAR TRADING REAL (CONECTAR CARTEIRA)",
        "btn_paper_trade": "TESTAR EXECUÇÃO PAPER",
        "btn_real_trade": "EXECUTAR TRADE ON-CHAIN",
        "preventivo_title": "ORÇAMENTO DE EXECUÇÃO ON-CHAIN",
        "preventivo_desc": "Cada transação on-chain é executada com proteção Position Guardian e cota DAO Blockchain+.",
        "preventivo_pair": "PAR DE TRADING:",
        "preventivo_action": "AÇÃO ALGORÍTMICA:",
        "preventivo_alloc": "VALOR ALOCADO:",
        "preventivo_dao_quota": "COTA DAO BLOCKCHAIN+ (POL):",
        "preventivo_gas": "GAS DE REDE ESTIMADO:",
        "preventivo_total": "TOTAL POL A ASSINAR:",
        "preventivo_recipient": "TESOURARIA DESTINO:",
        "btn_sign_trade": "ASSINAR ON-CHAIN (10 POL + GAS)",
        "btn_cancel": "CANCELAR",
        "pos_simulated": "SIMULADA",
        "pos_live": "LIVE ON-CHAIN",
        "btn_close_pos": "FECHAR POSIÇÃO EM USDT",
    ...
    ru: {
        ...
        chain_warning: " Неверная Сеть: Обнаружена сеть, отличная от Polygon POS (137).",
        ...
        btn_sign_execute: " ПОДПИСАТЬ И ВЫПОЛНИТЬ В POLYGON (USDT)",
        ...
        "btn_unlock_live": "АКТИВИРОВАТЬ РЕАЛЬНЫЙ ТРЕЙДИНГ",
        "btn_paper_trade": "ТЕСТ БУМАЖНОГО ИСПОЛНЕНИЯ",
        "btn_real_trade": "ВЫПОЛНИТЬ ОНЧЕЙН-СДЕЛКУ",
        "preventivo_title": "ОНЧЕЙН-СМЕТА ИСПОЛНЕНИЯ СДЕЛКИ",
        "preventivo_desc": "Каждая ончейн-сделка защищена Position Guardian с оплатой квоты DAO Blockchain+.",
        "preventivo_pair": "ТОРГОВАЯ ПАРА:",
        "preventivo_action": "АЛГОРИТМИЧЕСКОЕ ДЕЙСТВИЕ:",
        "preventivo_alloc": "СУММА ВЫДЕЛЕНИЯ:",
        "preventivo_dao_quota": "КВОТА DAO BLOCKCHAIN+ (POL):",
        "preventivo_gas": "ОЦЕНКА СЕТЕВОГО ГАЗА:",
        "preventivo_total": "ВСЕГО POL К ПОДПИСИ:",
        "preventivo_recipient": "КАЗНАЧЕЙСТВО DAO:",
        "btn_sign_trade": "ПОДПИСАТЬ ОНЧЕЙН (10 POL + GAS)",
        "btn_cancel": "ОТМЕНА",
        "pos_simulated": "СИМУЛЯЦИЯ",
        "pos_live": "ОНЧЕЙН ЛАЙВ",
        "btn_close_pos": "ЗАКРЫТЬ ПОЗИЦИЮ В USDT",
    ...
    ar: {
        ...
        disconnect: "فصل",
        chain_warning: " شبكة غير صحيحة: تم اكتشاف شبكة مختلفة عن Polygon POS (137).",
        ...
        btn_sign_execute: " التوقيع والتنفيذ على POLYGON (USDT)",
